    ...
    mounted: function(){
        ...
        uibuilder.onChange('msg', function(newVal){
            ...
            switch(newVal.topic) {
                ...
                case 'roomData':
                    vueApp.$store.commit('rooms/SAVE_ROOMS', newVal.payload);
                    break;

                // Process the list of schedules from node-red message
                case 'scheduleData':
                    vueApp.$store.commit('schedules/SAVE_SCHEDULES', newVal.payload);
                    break;
